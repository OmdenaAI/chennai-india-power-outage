...
if selected == 'Home':
    ...
    st.markdown('• • A visualisation dashboard is created to enter the date range to get the outage details of a specific area along with data visualisation collected from the satellites.',unsafe_allow_html=True)
